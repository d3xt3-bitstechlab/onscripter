...
class DemoRenderer extends GLSurfaceView_SDL.Renderer {
	...
	public void onDrawFrame(GL10 gl) {
		...
		nativeInit(ONScripter.gCurrentDirectoryPath, ONScripter.gWideScreen, ONScripter.gDisableRescale);
	...
	private native void nativeInit(String currentDirectoryPath, boolean ws, boolean dr);
